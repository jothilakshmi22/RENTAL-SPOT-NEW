    ...
    <Container>
      ...
      <Center>
        ...
        <List>
          ...
          <ListItem>Heavy equipment</ListItem>
          <ListItem>Construction equipment</ListItem>
          <ListItem>Dj equipment</ListItem>
          <ListItem>kitchen equipment</ListItem>
          <ListItem>Tools</ListItem>
          <ListItem>special equipment</ListItem>
          <ListItem>Photoghaphy</ListItem>
          <ListItem>Gym equipment</ListItem>
        </List>
      </Center>
      <Right>
        <Title>Contact</Title>
        <ContactItem>
          <Room style={{marginRight:"10px"}}/> kilpauk, Tamil Nadu ,India 
        </ContactItem>
        <ContactItem>
          <Phone style={{marginRight:"10px"}}/> +1 234 56 78
        </ContactItem>
        <ContactItem>
          <MailOutline style={{marginRight:"10px"}} /> contact@rentalspot.com
        </ContactItem>
